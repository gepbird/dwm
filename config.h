...
static const char* voltoggle[]        = { "chvol.sh", "set-mute", "toggle", NULL };
static const char* voldown[]          = { "chvol.sh", "set-volume", "10%-", NULL };
static const char* voldownlite[]      = { "chvol.sh", "set-volume", "1%-", NULL };
static const char* volup[]            = { "chvol.sh", "set-volume", "10%+", NULL };
static const char* voluplite[]        = { "chvol.sh", "set-volume", "1%+", NULL };
